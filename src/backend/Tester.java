...
public final class Tester {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Invalid point is invalid: " +
                           Cell.isPointValid(invalid.getPosition(),table.length,table[0].length));
        // adjacent cell testing
        System.out.println("Attempted correction: " +
                           Cell.correctCoor(invalid.getPosition(),table.length,table[0].length));
